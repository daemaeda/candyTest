...
use \Candy\Module\Manager as ModuleManager;
use \Candy\Menu\MenuManager;
...
/**
 * Candy Bootstrapper, initialize all the thing needed on the start
 */
class Bootstrap
{
    protected $app;
    ...
    /**
     * Setup Candy configuration and inject it to Slim instance
     * @param array $config
     */
